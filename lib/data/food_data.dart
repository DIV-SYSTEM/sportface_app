...
final List<FoodModel> foodData = [
  FoodModel(
    id: "event1",
    sportName: "Chole-Bhature",
    logoPath: "assets/images/chole.jpg",
    organiserName: "Demo User",
    venue: "Olive Bar and kitchen",
    city: "Delhi",
    description: "Looking for Chole Bhature food companion for Snack.",
    date: "2025-05-18",
    time: "5:00 PM",
    gender: "Any",
    ageLimit: "18-30",
  ...
  FoodModel(
    id: "event2",
    sportName: "Dal Pakwan",
    logoPath: "assets/images/dalpakwan.jpg",
    organiserName: "Rahul Verma",
    venue: "Bombay Fries",
    city: "Mumbai",
    description: "Looking for Dal Pakwan food companion for Lunch.",
    date: "2025-05-20",
    time: "2:00 PM",
    gender: "Male",
    ageLimit: "18-30",
  ...
  FoodModel(
    id: "event3",
    sportName: "Sandwich",
    logoPath: "assets/images/sandwich.jpg",
    organiserName: "Sneha Roy",
    venue: "Food Complex",
    city: "Bangalore",
    description: "Looking for Sandwich food companion for Dinner.",
    date: "2025-05-22",
    time: "9:00 PM",
    gender: "Female",
    ageLimit: "18-30",
